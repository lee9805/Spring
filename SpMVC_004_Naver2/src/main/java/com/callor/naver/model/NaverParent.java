...
/*
 * Spring 3.x 에서 새롭게 추가된 RestTemplath클래스를 사용하여
...
public class NaverParent<VO> {
	 ...
	 * 이때 RestTemplate 를 사용하여 데이터를 ㅏㄱ져오는데
	 *  RestTemplate 은 VO 를 감싸는 LISt 변수가 한개 필요한다
	 *  그런데 List 를 감싸는 VO가 news, book, movice 들이 각각 다르다
	 *  이럴때 Parent 클래스를 각각의 VO를 감싸는 타입으로
	 *  복수 정의해야 하는 문제가 있다
	 *  
	 *  이때도 Generic 의 기능을 사용하여
	 *  클래스 선언문 Generic 을 정의해 두고
	 *  
