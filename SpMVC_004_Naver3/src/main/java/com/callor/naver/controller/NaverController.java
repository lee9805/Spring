...
import com.callor.naver.service.impl.NaverServiceImplV1;
...
public class NaverController {
	...
	public NaverController(@Qualifier(QualifileConfig.SERVICE.NAVER_V2) NaverService naverService) {
	 ...
	 * String queryString =
	 * naverService.queryString("BOOK", title); List<BookVO> bookList =
	 * naverService.getNaverBook(queryString); model.addAttribute("BOOKS",bookList);
	 * return "naver/book_search"; }
	 */
