 ...
 */
@Slf4j
@Service(QualifileConfig.SERVICE.USER_V1)
public class UserServiceImplV1 implements UserService{
	...
	@Override
	public List<UserVO> fineByName(String name) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<UserVO> fineByNickName(String nickname) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<UserVO> fineByEmail(String email) {
		// TODO Auto-generated method stub
		return null;
	}
