...
@Slf4j
@Service(QualifileConfig.SERVICE.NAVER_V0)
public class NaverServiceImpl implements NaverService {
	 ...
	 * Naver에 요청할 QueryString 을 생성하는 method
	 */
