document.addEventListener("DOMContentLoaded", () => {
  ...
  table tag에 click event 를 설정하고
  매개변수(e)를 받는다
  이 매개변수는 클릭된 요속들에 대한 정보를 가지고 있다
  매개변수의 속성들 중에 target속성은
  가장 안쪽에 위치한 클릭된 tag 에 대한 정보를 가지고 있다
  만약 클릭된 tag가 td라면 자신(td)를 감싸고 있는 가장 가까운곳의
  tr tag 정보를 요청한다
  그리고tr tag에서 data-isbn  갑을 추출한다 : dataset.isbn 으로 추출한다
  */
  //if(book_table) {}
