...
<link rel="stylesheet" href="${rootPath}/static/css/modal.css?ver=2022-05-31-003">
<link rel="stylesheet" href="${rootPath}/static/css/input.css?ver=2022-05-31-002">
<script>
		...
		<form method="POST" action="${rootPath}/naver/books">
			...
			<div>
				<input name="author" placeholder="저자"> <input
					...
					placeholder="출판일"> <input name="price" placeholder="number">
			</div>
			<div>
