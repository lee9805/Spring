...
public class MemoServiceImplV1 implements MemoService {
	...
	public MemoServiceImplV1(MemoDao memoDao, FileUpService fileUp) {
		this.fileUp = fileUp;
	...
	public int insertAndUpdate(MemoDTO memo, MultipartFile file) {
		...
		//insert(새로추가)가 되는 경우는 m_seq가 0일 것이고,
		//update (수정)가 되는 경우는 m_seq가 0이 아닐 것이다
