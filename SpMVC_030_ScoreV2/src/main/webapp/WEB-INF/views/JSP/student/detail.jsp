...
<div class="student detail_body">
	<div>학년 :</div><div class="student detail">${STUDENT.st_dept}</div>
</div>
<div class="student detail_body">
...
<div>
<a href="${rootPath}/student/update?st_num=${STUDENT.st_num}"><button>수정</button></a>
<a href="${rootPath}/student"><button>리스트</button></a>
</div>