...
public class APIController {
	...
	/*
	 * http://localhost:8080/score/student/학번/delete로 요청을 했을때
	 * 학번에 해당하는 학생의 데이터를 삭제할수 있도록 method생성
	...
	public int intMethod() {
		return 0; 
		// return type 이 int 형 이므로 최소 0이라도 return 해야 한다
		//return 을 한다는 것은 이제 더이상 할일이 없어서 결과를 다시 되돌리기
		//return 을 만나면 method는 종료한다
	}
	public char charMethod() {
		return 'A'; // return type 이 char(문자)형 이므로 최소 한개의 임의 문자라도 return
	}
	
	//class(참조) type : String, VO, DTO, List 등의 클래스(객체) type return
	public String stMethod() {
		// return 할 값이 없으면 최소 null이라도 return해야한다
		// return 
		// return null :  나를 호출한 곳에 보낼 
