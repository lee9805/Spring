package com.callor.spring.exec;
 ...
 * 통신을 통해서 전송하는 것을 암호화라고 한다
 * 
 * 암호화된 특별한 문자열을 수신하여 다시 원래의 
 * 평문으로 변환하는 것을 복호화라고 한다
 * 
 * 인가 : 보안과 관련된 용어로
 ...
 * 	 회원가입할때 입력된 비번ㅇ르 암호화하여 table에 저장하고
 * 
 * 	이후 로그인을 시도하면
 * 	입력된 비번을 다시 암호화 하여 table에 저장된 값과
 * 	비교한다
 * 	복호화 기능이 존재하지 않으므로
...
public class CryptEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 평문을 암호화 하기
		 * 코드 내부에서 자도응로 생성되는 salt key에 의해
		 * 암호화를 할때마다 다근 값들이 추출된다
		 */
